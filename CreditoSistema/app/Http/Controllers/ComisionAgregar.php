...
class ComisionAgregar extends Controller
{ 
   ...
   $query=DB::table('dbo.tbl_creditos_plan_pagos')
    ...
    return view('AgregarComision', ['Creditos'=> $query], ['count'=>$query1]  );
 // return $planPago;
  ...
  /*$query=DB::table('dbo.tbl_creditos_plan_pagos')
    ...
    public function ActualizarC(Request $request){
        ...
        $query1 = DB::table('dbo.tbl_creditos_plan_pagos')
         ->where('tbl_creditos_plan_pagos.no_credito', $buscarpor)
         ->update(
            array('tbl_creditos_plan_pagos.comision_orig' =>  $comision_orig));
    ...
    public function InsertarCuota(Request $request){
       ...
       ->orderBy('dbo.tbl_creditos_plan_pagos.interes_orig', 'asc')
       ->take(1)
