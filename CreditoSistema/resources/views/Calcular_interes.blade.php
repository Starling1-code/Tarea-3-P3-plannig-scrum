    ...
    <div class="container">
      ...
      <tbody>   
        ...
        /*  $cuota = ($l->capital_orig + $l->interes_orig + $l->comision_orig + $l->otros);
          ...
          for ($i=0; $i <  13 ; $i++) { 
            //$date_future = mktime(0, 0, 1, $mes, $day+12,  $year);
       ...
       // $sumador_mora    = $sumador_mora    + $l->MORA;
        ...
        $total = number_format($total);
          ...
          @php
            ...
            $fecha = new DateTime($ls->fecha_cuota);
          $day = $fecha->format('d');
          $mes = $fecha->format('m');
          $year = $fecha->format('Y');
        ...
        // $Mora_periodos = $Mora * $IntentosF2;
           ...
           $Mora_periodos = $Mora * ($Dias_Venc / 30);
            ...
            $INT = ($INT_F * $i);
            $cuotaSumar = $l->no_cuota + $i;

           
            $cuota = ( $l->interes_orig + $l->comision_orig);
            $TasaCuota = 10;
            $Porcentaje = 100;
            $Mora = ($cuota) * $TasaCuota / $Porcentaje;
            ...
            $dias_meses_Frec4 = $dias_meses_Frec4 + 15;

             $fecha = date("d-m-Y",strtotime($FechaCuota."+".$dias_meses_Frec4. "days")); 
