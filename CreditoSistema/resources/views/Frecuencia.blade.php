    ...
    <div class="container">
      ...
      <tbody>   
        ...
        @foreach($Creditos as $l)
          ...
          <form action=" {{route('credito.Actualizar')}}" method="get">
            <label for="" class="comision">Frencuencia</label>
            <input class="CoOrig"  type="hidden" name="buscarpor" value="{{$l->cod_cliente}}" >  
